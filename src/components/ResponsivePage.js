  ...
  return (
    <div className="bg-white w-full h-full">
      <div className="mt-6 z-50 flex items-start">
        <h4 className="ml-5 text-blue-500 font-medium text-lg">My Assessments</h4>
        <h4 className={`${isLessThan400?'ml-6':'ml-16'} text-gray-700 font-medium text-lg`}>Unstop Assessments</h4>
      </div>
    ...
    {/* First Partition */}
          <div className="px-2 h-34 w-48 rounded-tl-lg rounded-bl-lg border-r-2 border-gray-200">
            ...
            <div className='flex justify-start'>
              <div className="bg-purple-200 h-10 w-10 rounded-xl flex justify-center items-center mt-3">
                <CiGrid2H size={20} className="text-violet-500 font-bold "/>
              </div>
        ...
        <div className="px-4 h-34 w-full border-b-2 border-gray-200 mb-4">
          ...
          <div className='flex justify-start'>
            <div className="bg-purple-200 h-10 w-10 rounded-xl flex justify-center items-center mt-4 relative mb-4">
              <MdPersonOutline size={20} className="absolute top-3 left-[8px] z-10 text-purple-600"/>
              <MdPerson size={20} className='text-violet-500 clip-person absolute top-3 left-[13px] transform -scale-x-100 pl-[1px]' />
            </div>
        ...
        <div className="px-4 h-34 w-full border-b-1 border-gray-200 mb-2">
          ...
          <div className='flex justify-start'>
            <div className={`bg-pink-100 ${isLessThan400?'h-8':'h-10'} ${isLessThan400?'w-8':'w-10'} rounded-xl flex justify-center items-center mt-3 relative`}>
              ...
              <ImArrowUpLeft2 className={`text-rose-600 ${isLessThan400?'top-5':'top-6'} ${isLessThan400?'left-[8px]':'left-[20px]'} absolute`} size={isLessThan400?8:10} />
            </div>
            <div className='flex items-center'>
      ...
      <div className='flex items-start mt-8'>
        ...
        <button className={` ml-3  cursor-pointer transform -scale-x-100 ${
            showPartitions ? 'bg-blue-100 rounded-3xl h-10 w-10 flex items-center justify-center text-blue-500 border border-blue-500' : 'text-blue-950'
          }`}>
